...
const AddSearchBox = ({ addRef, setTodos, todos, bloom }: IAddSearchBox) => {
     ...
     return (
          <div className="bg-blue-200/5 p-2 flex justify-between rounded-lg shadow-lg w-full max-w-md">
               <input
                    className="text-center focus:outline-none outline-none flex-1 px-5 rounded-md placeholder:text-center text-sm font-extralight tracking-widest bg-blue-500/5 text-blue-200 placeholder:hover:tracking-widest transition-all placeholder:duration-700 focus:placeholder:text-blue-500/55 placeholder:tracking-normal"
                    type="text"
